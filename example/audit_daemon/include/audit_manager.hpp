...
#include <xyz/openbmc_project/Logging/Audit/AuditBMCWEB/server.hpp>
...
using AuditBMCWEBIface =
    sdbusplus::xyz::openbmc_project::Logging::Audit::server::AuditBMCWEB;


using AuditIfaces = sdbusplus::server::object_t<ManagerIface, AuditIPMIIface, AuditBMCWEBIface>;
...
class Manager : public AuditIfaces
{
  public:
        ...
        AuditIfaces(bus, objPath)
    {
        ...
        AuditIPMIIface::allowList(_config->getIPMIAllowList());
        AuditBMCWEBIface::allowList(_config->getBMCWEBAllowList());
    }
