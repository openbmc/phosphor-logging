...
struct Event
{
    static constexpr auto err_code = "example.xyz.openbmc_project.Example.Event.Event";
...
struct TestErrorOne
{
    ...
    using DEV_ADDR = example::xyz::openbmc_project::Example::Elog::Error::TestErrorTwo::DEV_ADDR;
    using DEV_ID = example::xyz::openbmc_project::Example::Elog::Error::TestErrorTwo::DEV_ID;
    using DEV_NAME = example::xyz::openbmc_project::Example::Elog::Error::TestErrorTwo::DEV_NAME;
...
struct Foo
{
    ...
    using ERRNUM = example::xyz::openbmc_project::Example::Elog::Error::TestErrorOne::ERRNUM;
    using FILE_PATH = example::xyz::openbmc_project::Example::Elog::Error::TestErrorOne::FILE_PATH;
    using FILE_NAME = example::xyz::openbmc_project::Example::Elog::Error::TestErrorOne::FILE_NAME;
    using DEV_ADDR = example::xyz::openbmc_project::Example::Elog::Error::TestErrorTwo::DEV_ADDR;
    using DEV_ID = example::xyz::openbmc_project::Example::Elog::Error::TestErrorTwo::DEV_ID;
    using DEV_NAME = example::xyz::openbmc_project::Example::Elog::Error::TestErrorTwo::DEV_NAME;
...
struct Bar
{
    ...
    using FOO_DATA = example::xyz::openbmc_project::Example::Foo::Error::Foo::FOO_DATA;
    using ERRNUM = example::xyz::openbmc_project::Example::Elog::Error::TestErrorOne::ERRNUM;
    using FILE_PATH = example::xyz::openbmc_project::Example::Elog::Error::TestErrorOne::FILE_PATH;
    using FILE_NAME = example::xyz::openbmc_project::Example::Elog::Error::TestErrorOne::FILE_NAME;
    using DEV_ADDR = example::xyz::openbmc_project::Example::Elog::Error::TestErrorTwo::DEV_ADDR;
