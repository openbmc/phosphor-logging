...
class Manager
{
    public:
         ...
         *
         *  @param[in] msgid - The unique identifier of the journal entry to be committed.
         *  @param[in] emsg - The error exception message string associated with the error event log to be committed.
         */
        virtual void commit(
            i msgid,
            s emsg) = 0;
    ...
    private:
        ...
        interface::interface _xyz_openbmc_project_Logging_Manager_interface;
