...
{
    if (strcmp(text, "TestErrorTwo") == 0)
    {
        try
        {
            elog<example::xyz::openbmc_project::Example::TestErrorTwo>(
                    example::xyz::openbmc_project::Example::TestErrorTwo::
                        DEV_ADDR(0x12345678),
                    example::xyz::openbmc_project::Example::TestErrorTwo::
                        DEV_ID(123),
        ...
        catch (elogException<example::xyz::openbmc_project::Example::TestErrorTwo>& e)
        {
            std::cout << "elog exception caught: " << e.what() << std::endl;
            commit(e.name());
        }
