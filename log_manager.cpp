...
{
    sdbusplus::message::variant<bool> property;
...
void Manager::checkAndRemoveBlockingError(uint32_t entryId)
{
    ...
    {
        // grab the unique ptr and then erase from vector
        // the Block object is deleted once inst goes out of scope
