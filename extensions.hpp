...
using LogIDWithHwIsolationFunctions = std::vector<LogIDWithHwIsolationFunction>;
...
class Extensions
{
  public:
     ...
     * @return LogIDWithHwIsolationFunctions - the LogIDWithHwIsolationFunction
     * functions
     */
    static LogIDWithHwIsolationFunctions& getLogIDWithHwIsolationFunctions();
