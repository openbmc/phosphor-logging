...
using NonInfoLogsRotated =
    sdbusplus::xyz::openbmc_project::Logging::Error::NonInfoLogsRotated;
using InfoLogsRotated =
    sdbusplus::xyz::openbmc_project::Logging::Error::InfoLogsRotated;
...
class Manager : public details::ServerObject<details::ManagerIface>
{
  ...
  private:
    ...
    bool nonInfoErrorsRotated = false;
