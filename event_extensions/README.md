...
Creates runtime extension instances from requests.

Each extension implementation provides a corresponding Provider.

### Registry

Maintains the mapping between extension interface names and Providers.
