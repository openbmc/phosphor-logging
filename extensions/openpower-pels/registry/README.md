...
Suppose if multiple systems have same callouts, the 'Systems' key can be
used.The 'Systems' can accept the system names as an array of strings and the
list pf callouts common to those systems can be listed under the key.
...
procedure BMC0002 is called out.
