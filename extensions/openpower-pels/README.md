...
An example of saving JSON data to a file is and getting its file descriptor is:
...
If a PEL exceeds the maximum size of 16KB after these UserData sections are
added, UserData sections will be removed in the reverse order they were
received in the method argument vector until the size is under the limit.
