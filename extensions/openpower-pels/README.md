...
that FRU callout in the PEL if something other than high priority is desired.
...
- CALLOUT_INVENTORY_PATH
    ...
    a high callout is specified for this error in the message registry and the
    FRU callout needs to have a different priority.
