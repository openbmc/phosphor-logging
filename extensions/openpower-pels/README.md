...
SBE FFDC contains diffrent packets, which include SBE internal failure related
...
Incase non FAPI based failure, just keeps the raw FFDC data in the user section
