...
class PEL
{
  public:
    ...
    /**
     * @brief Convience function to return the log ID field from the
    ...
    /**
     * @brief Convience function to return the PLID field from the
     *        Private Header section.
     *
    ...
    /**
     * @brief Convience function to return the OpenBMC event log ID field
    ...
    /**
     * @brief Convience function to return the commit time field from
    ...
    /**
     * @brief Convience function to return the create time field from
     *        the Private Header section.
     *
     * @return BCDTime - the timestamp
     */
