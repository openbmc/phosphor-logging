...
void DataInterface::startFruPlugWatch()
{
    ...
    _fruWatches.emplace(
        "IA", std::make_unique<sdbusplus::bus::match_t>(
...
void DataInterface::inventoryIfaceAdded(sdbusplus::message_t& msg)
{
    ...
    {
        checkPresence(path.str, itemIt->second);
    }
}
...
void DataInterface::presenceChanged(sdbusplus::message_t& msg)
{
    ...
    checkPresence(path, properties);
}

void DataInterface::checkPresence(const std::string& path,
