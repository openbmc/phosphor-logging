...
DataInterface::DataInterface(sdbusplus::bus_t& bus) : _bus(bus), _slot(nullptr)
{
    readBMCFWVersion();
    readServerFWVersion();
    readBMCFWVersionID();
...
void DataInterface::subscribeToSystemdSignals()
{
    try
    {
        ...
        _slot = method.call_async([this](sdbusplus::message_t&& msg) {
            this->_slot = sdbusplus::slot_t(nullptr);
