...
class DataInterface : public DataInterfaceBase
{
  ...
  private:
     ...
     *        passed in and it is true, call the registered
     *        callbacks.
     */
    void checkPresence(const std::string& path,
     ...
     */
    std::map<std::string, std::unique_ptr<sdbusplus::bus::match_t>> _fruWatches;
