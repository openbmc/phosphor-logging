...
class DataInterfaceBase
{
  public:
    ...
    virtual DBusPathList getAssociatedPaths(
        const DBusPath& associatedPath, const std::string& subtree,
        int32_t depth, const DBusInterfaceList& interfaces) const = 0;
...
class DataInterface : public DataInterfaceBase
{
  public:
    ...
    DBusPathList getAssociatedPaths(
        const DBusPath& associatedPath, const std::string& subtree,
        int32_t depth, const DBusInterfaceList& interfaces) const override;
