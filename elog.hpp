...
/**
 * Structure used by callers to indicate they want to use the last value
...
{
/**
 * Used to return the generated tuple for the error code meta data
 *
...
/**
 * Used to return an empty tuple for prev_entry parameters
 *
...
/**
 * Typedef for above structure usage
 */
