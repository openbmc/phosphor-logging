...
void audit()
{
    try
    {
        constexpr auto aduitBusName = "xyz.openbmc_project.Logging.Audit";
        constexpr auto auditObjPath =
            "/xyz/openbmc_project/logging/audit/manager";
        constexpr auto auditIntf = "xyz.openbmc_project.Logging.Audit.Manager";
        constexpr auto auditMethod = "Notify";
