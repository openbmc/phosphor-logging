    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueTypeError(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PropertyValueTypeError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PropertyValueFormatError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueNotInList(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PropertyValueNotInList",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueOutOfRange(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PropertyValueOutOfRange",
    ...
    public RedfishMessage<std::string>
{
    ...
    PropertyValueError(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PropertyValueError",
    ...
    public RedfishMessage<std::string>
{
    ...
    PropertyNotWritable(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PropertyNotWritable",
    ...
    public RedfishMessage<std::string>
{
    ...
    PropertyNotUpdated(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PropertyNotUpdated",
    ...
    public RedfishMessage<std::string>
{
    ...
    ActionNotSupported(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ActionNotSupported",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterMissing(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ActionParameterMissing",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterDuplicate(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ActionParameterDuplicate",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterUnknown(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ActionParameterUnknown",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ActionParameterValueTypeError(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ActionParameterValueTypeError",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ActionParameterValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ActionParameterValueFormatError",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ActionParameterValueNotInList(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ActionParameterValueNotInList",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterValueError(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ActionParameterValueError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterNotSupported(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ActionParameterNotSupported",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    QueryParameterValueTypeError(Args... args) :
        RedfishMessage(
            "Base.1.12.0.QueryParameterValueTypeError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    QueryParameterValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.12.0.QueryParameterValueFormatError",
    ...
    public RedfishMessage<std::string>
{
    ...
    QueryParameterValueError(Args... args) :
        RedfishMessage(
            "Base.1.12.0.QueryParameterValueError",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    QueryParameterOutOfRange(Args... args) :
        RedfishMessage(
            "Base.1.12.0.QueryParameterOutOfRange",
    ...
    public RedfishMessage<>
{
    ...
    QueryNotSupportedOnResource(Args... args) :
        RedfishMessage(
            "Base.1.12.0.QueryNotSupportedOnResource",
    ...
    public RedfishMessage<>
{
    ...
    QueryNotSupportedOnOperation(Args... args) :
        RedfishMessage(
            "Base.1.12.0.QueryNotSupportedOnOperation",
    ...
    public RedfishMessage<>
{
    ...
    QueryCombinationInvalid(Args... args) :
        RedfishMessage(
            "Base.1.12.0.QueryCombinationInvalid",
    ...
    public RedfishMessage<>
{
    ...
    SessionLimitExceeded(Args... args) :
        RedfishMessage(
            "Base.1.12.0.SessionLimitExceeded",
    ...
    public RedfishMessage<>
{
    ...
    EventSubscriptionLimitExceeded(Args... args) :
        RedfishMessage(
            "Base.1.12.0.EventSubscriptionLimitExceeded",
    ...
    public RedfishMessage<>
{
    ...
    ResourceCannotBeDeleted(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ResourceCannotBeDeleted",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ResourceAlreadyExists(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ResourceAlreadyExists",
    ...
    public RedfishMessage<std::string>
{
    ...
    CreateFailedMissingReqProperties(Args... args) :
        RedfishMessage(
            "Base.1.12.0.CreateFailedMissingReqProperties",
    ...
    public RedfishMessage<>
{
    ...
    CreateLimitReachedForResource(Args... args) :
        RedfishMessage(
            "Base.1.12.0.CreateLimitReachedForResource",
    ...
    public RedfishMessage<>
{
    ...
    ServiceShuttingDown(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ServiceShuttingDown",
    ...
    public RedfishMessage<>
{
    ...
    ServiceInUnknownState(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ServiceInUnknownState",
    ...
    public RedfishMessage<>
{
    ...
    InsufficientPrivilege(Args... args) :
        RedfishMessage(
            "Base.1.12.0.InsufficientPrivilege",
    ...
    public RedfishMessage<>
{
    ...
    AccountNotModified(Args... args) :
        RedfishMessage(
            "Base.1.12.0.AccountNotModified",
    ...
    public RedfishMessage<>
{
    ...
    AccountForSessionNoLongerExists(Args... args) :
        RedfishMessage(
            "Base.1.12.0.AccountForSessionNoLongerExists",
    ...
    public RedfishMessage<>
{
    ...
    UnrecognizedRequestBody(Args... args) :
        RedfishMessage(
            "Base.1.12.0.UnrecognizedRequestBody",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceMissingAtURI(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ResourceMissingAtURI",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceAtUriInUnknownFormat(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ResourceAtUriInUnknownFormat",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceAtUriUnauthorized(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ResourceAtUriUnauthorized",
    ...
    public RedfishMessage<std::string>
{
    ...
    CouldNotEstablishConnection(Args... args) :
        RedfishMessage(
            "Base.1.12.0.CouldNotEstablishConnection",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    SourceDoesNotSupportProtocol(Args... args) :
        RedfishMessage(
            "Base.1.12.0.SourceDoesNotSupportProtocol",
    ...
    public RedfishMessage<std::string>
{
    ...
    ServiceTemporarilyUnavailable(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ServiceTemporarilyUnavailable",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueModified(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PropertyValueModified",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceExhaustion(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ResourceExhaustion",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    StringValueTooLong(Args... args) :
        RedfishMessage(
            "Base.1.12.0.StringValueTooLong",
    ...
    public RedfishMessage<>
{
    ...
    SubscriptionTerminated(Args... args) :
        RedfishMessage(
            "Base.1.12.0.SubscriptionTerminated",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceTypeIncompatible(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ResourceTypeIncompatible",
    ...
    public RedfishMessage<std::string>
{
    ...
    PasswordChangeRequired(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PasswordChangeRequired",
    ...
    public RedfishMessage<std::string>
{
    ...
    ChassisPowerStateOnRequired(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ChassisPowerStateOnRequired",
    ...
    public RedfishMessage<std::string>
{
    ...
    ChassisPowerStateOffRequired(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ChassisPowerStateOffRequired",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueConflict(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PropertyValueConflict",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    PropertyValueResourceConflict(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PropertyValueResourceConflict",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueExternalConflict(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PropertyValueExternalConflict",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueIncorrect(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PropertyValueIncorrect",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceCreationConflict(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ResourceCreationConflict",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterValueConflict(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ActionParameterValueConflict",
    ...
    public RedfishMessage<>
{
    ...
    MaximumErrorsExceeded(Args... args) :
        RedfishMessage(
            "Base.1.12.0.MaximumErrorsExceeded",
    ...
    public RedfishMessage<>
{
    ...
    PreconditionFailed(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PreconditionFailed",
    ...
    public RedfishMessage<>
{
    ...
    PreconditionRequired(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PreconditionRequired",
    ...
    public RedfishMessage<>
{
    ...
    ConditionInRelatedResource(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ConditionInRelatedResource",
            "Indicates that one or more fault or error conditions exist in a related resource.",
            "This message shall be used to indicate that one or more conditions that require attention exist in a resource that affects the Health or HealthRollup of this resource.  The resource can be located using the `OriginOfCondition` property.",
    ...
    public RedfishMessage<std::string>
{
    ...
    RestrictedPrivilege(Args... args) :
        RedfishMessage(
            "Base.1.12.0.RestrictedPrivilege",
    ...
    public RedfishMessage<std::string>
{
    ...
    StrictAccountTypes(Args... args) :
        RedfishMessage(
            "Base.1.12.0.StrictAccountTypes",
    ...
    public RedfishMessage<std::string>
{
    ...
    PropertyDeprecated(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PropertyDeprecated",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceDeprecated(Args... args) :
        RedfishMessage(
            "Base.1.12.0.ResourceDeprecated",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueDeprecated(Args... args) :
        RedfishMessage(
            "Base.1.12.0.PropertyValueDeprecated",
    ...
    public RedfishMessage<>
{
    ...
    NetworkNameResolutionNotConfigured(Args... args) :
        RedfishMessage(
            "Base.1.12.0.NetworkNameResolutionNotConfigured",
    ...
    public RedfishMessage<>
{
    ...
    NetworkNameResolutionNotSupported(Args... args) :
        RedfishMessage(
            "Base.1.12.0.NetworkNameResolutionNotSupported",
