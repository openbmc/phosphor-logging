    ...
    public RedfishMessage<>
{
    ...
    ResourceCreated(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceCreated",
    ...
    public RedfishMessage<>
{
    ...
    ResourceRemoved(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceRemoved",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceErrorsDetected(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceErrorsDetected",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceErrorsCorrected(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceErrorsCorrected",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    ResourceErrorThresholdExceeded(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceErrorThresholdExceeded",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    ResourceErrorThresholdCleared(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceErrorThresholdCleared",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    ResourceWarningThresholdExceeded(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceWarningThresholdExceeded",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    ResourceWarningThresholdCleared(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceWarningThresholdCleared",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceStatusChangedOK(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceStatusChangedOK",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceStatusChangedWarning(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceStatusChangedWarning",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceStatusChangedCritical(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceStatusChangedCritical",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceStateChanged(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceStateChanged",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourcePoweredOn(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourcePoweredOn",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourcePoweringOn(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourcePoweringOn",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourcePoweredOff(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourcePoweredOff",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourcePoweringOff(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourcePoweringOff",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourcePaused(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourcePaused",
    ...
    public RedfishMessage<>
{
    ...
    URIForResourceChanged(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.URIForResourceChanged",
    ...
    public RedfishMessage<>
{
    ...
    ResourceChanged(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceChanged",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceVersionIncompatible(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceVersionIncompatible",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceSelfTestFailed(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceSelfTestFailed",
    ...
    public RedfishMessage<>
{
    ...
    ResourceSelfTestCompleted(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.ResourceSelfTestCompleted",
    ...
    public RedfishMessage<>
{
    ...
    TestMessage(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.TestMessage",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    AggregationSourceDiscovered(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.AggregationSourceDiscovered",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    LicenseExpired(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.LicenseExpired",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    LicenseChanged(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.LicenseChanged",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    LicenseAdded(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.3.1.LicenseAdded",
