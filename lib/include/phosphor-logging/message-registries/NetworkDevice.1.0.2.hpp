    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    CableInserted(Args... args) :
        RedfishMessage(
            "NetworkDevice.1.0.2.CableInserted",
            ...
            { "The value of this argument shall contain a string that identifies or describes the location or physical context of the network adapter into which a cable has been plugged.", "The value of this argument shall contain a string that identifies or describes the location or physical context of the network port into which a cable has been plugged." },
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    CableRemoved(Args... args) :
        RedfishMessage(
            "NetworkDevice.1.0.2.CableRemoved",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ConnectionDropped(Args... args) :
        RedfishMessage(
            "NetworkDevice.1.0.2.ConnectionDropped",
            ...
            { "The value of this argument shall contain a string that identifies or describes the location or physical context of the network adapter from which a connection has dropped.", "The value of this argument shall contain a string that identifies or describes the location or physical context of the network port from which a connection has dropped.", "The value of this argument shall contain a string that identifies or describes the location or physical context of the network device function from which a connection has dropped." },
            "Refresh your cached version of the network port to get the updated information from the service.",
            std::make_tuple(std::forward<Args>(args)...))
    {}
};
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ConnectionEstablished(Args... args) :
        RedfishMessage(
            "NetworkDevice.1.0.2.ConnectionEstablished",
            ...
            { "string", "string", "string" },
            { "The name or identifier of network adapter.", "The name or identifier of network port.", "The name or identifier of network function." },
            { "The value of this argument shall contain a string that identifies or describes the location or physical context of the network adapter to which a connection has been established.", "The value of this argument shall contain a string that identifies or describes the location or physical context of the network port to which a connection has been established.", "The value of this argument shall contain a string that identifies or describes the location or physical context of the network device function to which a connection has been established." },
            "Refresh your cached version of the network port to get the updated information from the service.",
            std::make_tuple(std::forward<Args>(args)...))
    {}
};
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    DegradedConnectionEstablished(Args... args) :
        RedfishMessage(
            "NetworkDevice.1.0.2.DegradedConnectionEstablished",
    ...
    public RedfishMessage<std::string, std::string, std::string, double, double>
{
    ...
    LinkFlapDetected(Args... args) :
        RedfishMessage(
            "NetworkDevice.1.0.2.LinkFlapDetected",
            ...
            { "The value of this argument shall contain a string that identifies or describes the location or physical context of the network adapter to which a connection has been established.", "The value of this argument shall contain a string that identifies or describes the location or physical context of the network port to which a connection has been established.", "The value of this argument shall contain a string that identifies or describes the location or physical context of the network device function to which a connection has been established.", "The value of this argument shall be a number representing the count of link establishment/disconnection cycles.", "The value of this argument shall be a number representing the number of minutes over which link flapping activity has been detected." },
