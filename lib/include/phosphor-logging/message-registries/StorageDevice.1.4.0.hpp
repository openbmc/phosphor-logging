    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerOK(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.ControllerOK",
    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.ControllerFailure",
...
struct DrivePredictiveFailure :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    DrivePredictiveFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.DrivePredictiveFailure",
...
struct DrivePredictiveFailureCleared :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    DrivePredictiveFailureCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.DrivePredictiveFailureCleared",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.DriveFailure",
...
struct DriveFailureCleared :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    DriveFailureCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.DriveFailureCleared",
...
struct DriveInserted :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    DriveInserted(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.DriveInserted",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveRemoved(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.DriveRemoved",
            "A drive was removed.",
...
struct VolumeDegraded :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    VolumeDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.VolumeDegraded",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VolumeFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.VolumeFailure",
...
struct WriteCacheProtected :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    WriteCacheProtected(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.WriteCacheProtected",
...
struct WriteCacheTemporarilyDegraded :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    WriteCacheTemporarilyDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.WriteCacheTemporarilyDegraded",
...
struct WriteCacheDegraded :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    WriteCacheDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.WriteCacheDegraded",
...
struct WriteCacheDataLoss :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    WriteCacheDataLoss(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.WriteCacheDataLoss",
    ...
    public RedfishMessage<std::string>
{
    ...
    BatteryCharging(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.BatteryCharging",
...
struct BatteryMissing :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    BatteryMissing(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.BatteryMissing",
...
struct BatteryFailure :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    BatteryFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.BatteryFailure",
...
struct ControllerDegraded :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    ControllerDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.ControllerDegraded",
...
struct ControllerPreviousError :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    ControllerPreviousError(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.ControllerPreviousError",
...
struct ControllerPasswordAccepted :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    ControllerPasswordAccepted(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.ControllerPasswordAccepted",
...
struct ControllerPasswordRequired :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    ControllerPasswordRequired(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.ControllerPasswordRequired",
...
struct ControllerPortOK :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    ControllerPortOK(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.ControllerPortOK",
...
struct ControllerPortDegraded :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    ControllerPortDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.ControllerPortDegraded",
...
struct ControllerPortFailure :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    ControllerPortFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.ControllerPortFailure",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveMissing(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.DriveMissing",
...
struct DriveMissingCleared :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    DriveMissingCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.DriveMissingCleared",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveOffline(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.DriveOffline",
...
struct DriveOfflineCleared :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    DriveOfflineCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.DriveOfflineCleared",
...
struct VolumeOffline :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    VolumeOffline(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.VolumeOffline",
...
struct [[deprecated ("This message was deprecated in favor of `VolumeOffline` due to a typographic error in the `MessageId`.")]]
VolumeOffine :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    VolumeOffine(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.VolumeOffine",
            "The storage controller has detected an offline volume condition.",
            "This message shall indicate a volume offline condition was detected.  This may occur if the volume configuration is not supported or needs to be imported.",
            "The volume '%1' attached to the storage controller located in '%2' is offline.",
            "Critical",
...
struct VolumeOfflineCleared :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    VolumeOfflineCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.VolumeOfflineCleared",
...
struct BlockSecurityIDIssued :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    BlockSecurityIDIssued(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.BlockSecurityIDIssued",
            ...
            "The TCG-defined command to block establishment of a security ID was issued to the drive located in '%1'.",
            "OK",
            1,
            { "string" },
            { "The location of the drive." },
...
struct BlockSecurityIDFailed :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    BlockSecurityIDFailed(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.BlockSecurityIDFailed",
            ...
            "The TCG-defined command to block establishment of a security ID failed when issued to the drive located in '%1'.",
            "Warning",
            1,
            { "string" },
            { "The location of the drive." },
            { "This argument shall contain the drive location." },
            "Update the drive firmware or replace the drive.",
            std::make_tuple(std::forward<Args>(args)...))
    {}
};

struct BlockSecurityIDRemoved :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    BlockSecurityIDRemoved(Args... args) :
        RedfishMessage(
            "StorageDevice.1.4.0.BlockSecurityIDRemoved",
            ...
            "The TCG-defined command to block establishment of a security ID are no longer sent to the drive located in '%1'.",
            "OK",
            1,
            { "string" },
            { "The location of the drive." },
