    ...
    public RedfishMessage<>
{
    ...
    AllTargetsDetermined(Args... args) :
        RedfishMessage(
            "Update.1.0.0.AllTargetsDetermined",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    TransferringToComponent(Args... args) :
        RedfishMessage(
            "Update.1.0.0.TransferringToComponent",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VerifyingAtComponent(Args... args) :
        RedfishMessage(
            "Update.1.0.0.VerifyingAtComponent",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    InstallingOnComponent(Args... args) :
        RedfishMessage(
            "Update.1.0.0.InstallingOnComponent",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ApplyingOnComponent(Args... args) :
        RedfishMessage(
            "Update.1.0.0.ApplyingOnComponent",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VerificationFailed(Args... args) :
        RedfishMessage(
            "Update.1.0.0.VerificationFailed",
    ...
    public RedfishMessage<std::string>
{
    ...
    OperationTransitionedToJob(Args... args) :
        RedfishMessage(
            "Update.1.0.0.OperationTransitionedToJob",
