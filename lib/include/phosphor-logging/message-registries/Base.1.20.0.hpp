...
struct PropertyUnknown :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    PropertyUnknown(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyUnknown",
...
struct PropertyValueFormatError :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    PropertyValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyValueFormatError",
...
struct PropertyValueNotInList :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    PropertyValueNotInList(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyValueNotInList",
...
struct PropertyValueOutOfRange :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    PropertyValueOutOfRange(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyValueOutOfRange",
...
struct PropertyValueError :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    PropertyValueError(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyValueError",
...
struct PropertyNotWritable :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    PropertyNotWritable(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyNotWritable",
...
struct PropertyNotUpdated :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    PropertyNotUpdated(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyNotUpdated",
...
struct PropertyMissing :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    PropertyMissing(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyMissing",
...
struct ActionNotSupported :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    ActionNotSupported(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ActionNotSupported",
...
struct ActionParameterMissing :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    ActionParameterMissing(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ActionParameterMissing",
...
struct ActionParameterDuplicate :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    ActionParameterDuplicate(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ActionParameterDuplicate",
...
struct ActionParameterUnknown :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    ActionParameterUnknown(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ActionParameterUnknown",
...
struct ActionParameterValueFormatError :
    public RedfishMessage<std::string, std::string, std::string>
{
    template <typename... Args>
    ActionParameterValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ActionParameterValueFormatError",
...
struct ActionParameterValueNotInList :
    public RedfishMessage<std::string, std::string, std::string>
{
    template <typename... Args>
    ActionParameterValueNotInList(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ActionParameterValueNotInList",
...
struct ActionParameterValueOutOfRange :
    public RedfishMessage<std::string, std::string, std::string>
{
    template <typename... Args>
    ActionParameterValueOutOfRange(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ActionParameterValueOutOfRange",
...
struct ActionParameterValueError :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    ActionParameterValueError(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ActionParameterValueError",
...
struct ActionParameterNotSupported :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    ActionParameterNotSupported(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ActionParameterNotSupported",
...
struct ArraySizeTooShort :
    public RedfishMessage<std::string, double>
{
    template <typename... Args>
    ArraySizeTooShort(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ArraySizeTooShort",
...
struct QueryParameterValueTypeError :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    QueryParameterValueTypeError(Args... args) :
        RedfishMessage(
            "Base.1.20.0.QueryParameterValueTypeError",
...
struct QueryParameterValueFormatError :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    QueryParameterValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.20.0.QueryParameterValueFormatError",
...
struct QueryParameterValueError :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    QueryParameterValueError(Args... args) :
        RedfishMessage(
            "Base.1.20.0.QueryParameterValueError",
...
struct QueryParameterOutOfRange :
    public RedfishMessage<std::string, std::string, std::string>
{
    template <typename... Args>
    QueryParameterOutOfRange(Args... args) :
        RedfishMessage(
            "Base.1.20.0.QueryParameterOutOfRange",
...
struct QueryNotSupportedOnResource :
    public RedfishMessage<>
{
    template <typename... Args>
    QueryNotSupportedOnResource(Args... args) :
        RedfishMessage(
            "Base.1.20.0.QueryNotSupportedOnResource",
...
struct QueryNotSupportedOnOperation :
    public RedfishMessage<>
{
    template <typename... Args>
    QueryNotSupportedOnOperation(Args... args) :
        RedfishMessage(
            "Base.1.20.0.QueryNotSupportedOnOperation",
...
struct QueryNotSupported :
    public RedfishMessage<>
{
    template <typename... Args>
    QueryNotSupported(Args... args) :
        RedfishMessage(
            "Base.1.20.0.QueryNotSupported",
...
struct QueryCombinationInvalid :
    public RedfishMessage<>
{
    template <typename... Args>
    QueryCombinationInvalid(Args... args) :
        RedfishMessage(
            "Base.1.20.0.QueryCombinationInvalid",
...
struct QueryParameterUnsupported :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    QueryParameterUnsupported(Args... args) :
        RedfishMessage(
            "Base.1.20.0.QueryParameterUnsupported",
...
struct SessionLimitExceeded :
    public RedfishMessage<>
{
    template <typename... Args>
    SessionLimitExceeded(Args... args) :
        RedfishMessage(
            "Base.1.20.0.SessionLimitExceeded",
...
struct EventSubscriptionLimitExceeded :
    public RedfishMessage<>
{
    template <typename... Args>
    EventSubscriptionLimitExceeded(Args... args) :
        RedfishMessage(
            "Base.1.20.0.EventSubscriptionLimitExceeded",
...
struct ResourceCannotBeDeleted :
    public RedfishMessage<>
{
    template <typename... Args>
    ResourceCannotBeDeleted(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ResourceCannotBeDeleted",
...
struct ResourceAlreadyExists :
    public RedfishMessage<std::string, std::string, std::string>
{
    template <typename... Args>
    ResourceAlreadyExists(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ResourceAlreadyExists",
...
struct InsufficientStorage :
    public RedfishMessage<>
{
    template <typename... Args>
    InsufficientStorage(Args... args) :
        RedfishMessage(
            "Base.1.20.0.InsufficientStorage",
...
struct MissingOrMalformedPart :
    public RedfishMessage<>
{
    template <typename... Args>
    MissingOrMalformedPart(Args... args) :
        RedfishMessage(
            "Base.1.20.0.MissingOrMalformedPart",
...
struct [[deprecated ("This message was deprecated in favor of `PropertyMissing`.")]]
    ...
    public RedfishMessage<std::string>
{
    ...
    CreateFailedMissingReqProperties(Args... args) :
        RedfishMessage(
            "Base.1.20.0.CreateFailedMissingReqProperties",
...
struct CreateLimitReachedForResource :
    public RedfishMessage<>
{
    template <typename... Args>
    CreateLimitReachedForResource(Args... args) :
        RedfishMessage(
            "Base.1.20.0.CreateLimitReachedForResource",
...
struct ServiceShuttingDown :
    public RedfishMessage<>
{
    template <typename... Args>
    ServiceShuttingDown(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ServiceShuttingDown",
...
struct ServiceInUnknownState :
    public RedfishMessage<>
{
    template <typename... Args>
    ServiceInUnknownState(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ServiceInUnknownState",
    ...
    public RedfishMessage<>
{
    ...
    InsufficientPrivilege(Args... args) :
        RedfishMessage(
            "Base.1.20.0.InsufficientPrivilege",
...
struct AccountModified :
    public RedfishMessage<>
{
    template <typename... Args>
    AccountModified(Args... args) :
        RedfishMessage(
            "Base.1.20.0.AccountModified",
...
struct AccountNotModified :
    public RedfishMessage<>
{
    template <typename... Args>
    AccountNotModified(Args... args) :
        RedfishMessage(
            "Base.1.20.0.AccountNotModified",
...
struct AccountForSessionNoLongerExists :
    public RedfishMessage<>
{
    template <typename... Args>
    AccountForSessionNoLongerExists(Args... args) :
        RedfishMessage(
            "Base.1.20.0.AccountForSessionNoLongerExists",
...
struct UnrecognizedRequestBody :
    public RedfishMessage<>
{
    template <typename... Args>
    UnrecognizedRequestBody(Args... args) :
        RedfishMessage(
            "Base.1.20.0.UnrecognizedRequestBody",
...
struct ResourceMissingAtURI :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    ResourceMissingAtURI(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ResourceMissingAtURI",
...
struct ResourceAtUriInUnknownFormat :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    ResourceAtUriInUnknownFormat(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ResourceAtUriInUnknownFormat",
...
struct ResourceAtUriUnauthorized :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    ResourceAtUriUnauthorized(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ResourceAtUriUnauthorized",
...
struct CouldNotEstablishConnection :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    CouldNotEstablishConnection(Args... args) :
        RedfishMessage(
            "Base.1.20.0.CouldNotEstablishConnection",
...
struct SourceDoesNotSupportProtocol :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    SourceDoesNotSupportProtocol(Args... args) :
        RedfishMessage(
            "Base.1.20.0.SourceDoesNotSupportProtocol",
...
struct ServiceTemporarilyUnavailable :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    ServiceTemporarilyUnavailable(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ServiceTemporarilyUnavailable",
...
struct PropertyValueModified :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    PropertyValueModified(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyValueModified",
...
struct ResourceInStandby :
    public RedfishMessage<>
{
    template <typename... Args>
    ResourceInStandby(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ResourceInStandby",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceExhaustion(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ResourceExhaustion",
...
struct StringValueTooLong :
    public RedfishMessage<std::string, double>
{
    template <typename... Args>
    StringValueTooLong(Args... args) :
        RedfishMessage(
            "Base.1.20.0.StringValueTooLong",
...
struct StringValueTooShort :
    public RedfishMessage<std::string, double>
{
    template <typename... Args>
    StringValueTooShort(Args... args) :
        RedfishMessage(
            "Base.1.20.0.StringValueTooShort",
...
struct SubscriptionTerminated :
    public RedfishMessage<>
{
    template <typename... Args>
    SubscriptionTerminated(Args... args) :
        RedfishMessage(
            "Base.1.20.0.SubscriptionTerminated",
...
struct ResourceTypeIncompatible :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    ResourceTypeIncompatible(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ResourceTypeIncompatible",
    ...
    public RedfishMessage<std::string>
{
    ...
    PasswordChangeRequired(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PasswordChangeRequired",
...
struct ResetRecommended :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    ResetRecommended(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ResetRecommended",
...
struct ChassisPowerStateOnRequired :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    ChassisPowerStateOnRequired(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ChassisPowerStateOnRequired",
...
struct ChassisPowerStateOffRequired :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    ChassisPowerStateOffRequired(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ChassisPowerStateOffRequired",
...
struct PropertyValueConflict :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    PropertyValueConflict(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyValueConflict",
...
struct PropertyValueResourceConflict :
    public RedfishMessage<std::string, std::string, std::string>
{
    template <typename... Args>
    PropertyValueResourceConflict(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyValueResourceConflict",
...
struct PropertyValueExternalConflict :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    PropertyValueExternalConflict(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyValueExternalConflict",
...
struct PropertyValueIncorrect :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    PropertyValueIncorrect(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyValueIncorrect",
...
struct ResourceCreationConflict :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    ResourceCreationConflict(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ResourceCreationConflict",
...
struct ActionParameterValueConflict :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    ActionParameterValueConflict(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ActionParameterValueConflict",
...
struct MaximumErrorsExceeded :
    public RedfishMessage<>
{
    template <typename... Args>
    MaximumErrorsExceeded(Args... args) :
        RedfishMessage(
            "Base.1.20.0.MaximumErrorsExceeded",
    ...
    public RedfishMessage<>
{
    ...
    PreconditionFailed(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PreconditionFailed",
...
struct PreconditionRequired :
    public RedfishMessage<>
{
    template <typename... Args>
    PreconditionRequired(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PreconditionRequired",
...
struct OperationNotAllowed :
    public RedfishMessage<>
{
    template <typename... Args>
    OperationNotAllowed(Args... args) :
        RedfishMessage(
            "Base.1.20.0.OperationNotAllowed",
...
struct UndeterminedFault :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    UndeterminedFault(Args... args) :
        RedfishMessage(
            "Base.1.20.0.UndeterminedFault",
...
struct ConditionInRelatedResource :
    public RedfishMessage<>
{
    template <typename... Args>
    ConditionInRelatedResource(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ConditionInRelatedResource",
...
struct RestrictedRole :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    RestrictedRole(Args... args) :
        RedfishMessage(
            "Base.1.20.0.RestrictedRole",
...
struct RestrictedPrivilege :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    RestrictedPrivilege(Args... args) :
        RedfishMessage(
            "Base.1.20.0.RestrictedPrivilege",
...
struct StrictAccountTypes :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    StrictAccountTypes(Args... args) :
        RedfishMessage(
            "Base.1.20.0.StrictAccountTypes",
...
struct PropertyDeprecated :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    PropertyDeprecated(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyDeprecated",
...
struct ResourceDeprecated :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    ResourceDeprecated(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ResourceDeprecated",
...
struct PropertyValueDeprecated :
    public RedfishMessage<std::string, std::string>
{
    template <typename... Args>
    PropertyValueDeprecated(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyValueDeprecated",
...
struct ActionDeprecated :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    ActionDeprecated(Args... args) :
        RedfishMessage(
            "Base.1.20.0.ActionDeprecated",
...
struct NetworkNameResolutionNotConfigured :
    public RedfishMessage<>
{
    template <typename... Args>
    NetworkNameResolutionNotConfigured(Args... args) :
        RedfishMessage(
            "Base.1.20.0.NetworkNameResolutionNotConfigured",
...
struct NetworkNameResolutionNotSupported :
    public RedfishMessage<>
{
    template <typename... Args>
    NetworkNameResolutionNotSupported(Args... args) :
        RedfishMessage(
            "Base.1.20.0.NetworkNameResolutionNotSupported",
...
struct EventBufferExceeded :
    public RedfishMessage<>
{
    template <typename... Args>
    EventBufferExceeded(Args... args) :
        RedfishMessage(
            "Base.1.20.0.EventBufferExceeded",
...
struct AuthenticationTokenRequired :
    public RedfishMessage<>
{
    template <typename... Args>
    AuthenticationTokenRequired(Args... args) :
        RedfishMessage(
            "Base.1.20.0.AuthenticationTokenRequired",
...
struct OneTimePasscodeSent :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    OneTimePasscodeSent(Args... args) :
        RedfishMessage(
            "Base.1.20.0.OneTimePasscodeSent",
...
struct LicenseRequired :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    LicenseRequired(Args... args) :
        RedfishMessage(
            "Base.1.20.0.LicenseRequired",
...
struct PropertyModified :
    public RedfishMessage<>
{
    template <typename... Args>
    PropertyModified(Args... args) :
        RedfishMessage(
            "Base.1.20.0.PropertyModified",
...
struct GenerateSecretKeyRequired :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    GenerateSecretKeyRequired(Args... args) :
        RedfishMessage(
            "Base.1.20.0.GenerateSecretKeyRequired",
...
struct AccessUnauthorized :
    public RedfishMessage<>
{
    template <typename... Args>
    AccessUnauthorized(Args... args) :
        RedfishMessage(
            "Base.1.20.0.AccessUnauthorized",
            "Indicates that the request did not contain valid credentials.",
            "This message shall indicate that the request did not contain valid credentials, such as those found in the `Authorization` and `X-Auth-Token` HTTP request headers.",
            "Unauthorized.",
            "Critical",
            0,
            {},
            {},
            {},
            "Resubmit the request with valid credentials.",
            std::make_tuple(std::forward<Args>(args)...))
    {}
};
...
{
    template <typename... Args>
    AccessForbidden(Args... args) :
        RedfishMessage(
            "Base.1.20.0.AccessForbidden",
            ...
            {},
            {},
            "Resubmit the request with credentials that contain the necessary privileges to perform the requested operation.",
            std::make_tuple(std::forward<Args>(args)...))
    {}
};
