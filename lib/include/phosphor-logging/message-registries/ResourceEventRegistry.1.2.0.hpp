...
{
namespace ResourceEventRegistry_1_2_0
{
    ...
    public RedfishMessage<>
{
    ...
    ResourceCreated(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceCreated",
    ...
    public RedfishMessage<>
{
    ...
    ResourceRemoved(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceRemoved",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceErrorsDetected(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceErrorsDetected",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceErrorsCorrected(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceErrorsCorrected",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceErrorThresholdExceeded(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceErrorThresholdExceeded",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceErrorThresholdCleared(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceErrorThresholdCleared",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceWarningThresholdExceeded(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceWarningThresholdExceeded",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceWarningThresholdCleared(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceWarningThresholdCleared",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceStatusChangedOK(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceStatusChangedOK",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceStatusChangedWarning(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceStatusChangedWarning",
            "The state of resource %1 has changed to state type %2. The state types shall be used from Resource.State.",
            "The state of resource %1 has changed to state type %2. The state types shall be used from Resource.State.",
            "The state of resource %1 has changed to state type %2.",
            "Warning",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceStatusChangedCritical(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceStatusChangedCritical",
            "The state of resource %1 has changed to state type %2. The state types shall be used from Resource.State.",
            "The state of resource %1 has changed to state type %2. The state types shall be used from Resource.State.",
            "The state of resource %1 has changed to state type %2.",
            "Critical",
    ...
    public RedfishMessage<>
{
    ...
    URIForResourceChanged(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.URIForResourceChanged",
    ...
    public RedfishMessage<>
{
    ...
    ResourceChanged(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceChanged",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceVersionIncompatible(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceVersionIncompatible",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceSelfTestFailed(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceSelfTestFailed",
    ...
    public RedfishMessage<>
{
    ...
    ResourceSelfTestCompleted(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.ResourceSelfTestCompleted",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    LicenseExpired(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.LicenseExpired",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    LicenseChanged(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.LicenseChanged",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    LicenseAdded(Args... args) :
        RedfishMessage(
            "ResourceEventRegistry.1.2.0.LicenseAdded",
