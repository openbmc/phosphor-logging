...
{
namespace Update_1_0_2
{

struct [[deprecated ("Use Update_1_1_1")]]
TargetDetermined :
    public RedfishMessage<std::string, std::string>
{
    ...
    TargetDetermined(Args... args) :
        RedfishMessage(
            ...
            2,
            { "string", "string" },
            { "The URI or name of the target that will be updated.", "The identfier for the image." },
    ...
    public RedfishMessage<>
{
    ...
    AllTargetsDetermined(Args... args) :
        RedfishMessage(
            "Update.1.0.2.AllTargetsDetermined",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    TransferringToComponent(Args... args) :
        RedfishMessage(
            "Update.1.0.2.TransferringToComponent",
            ...
            2,
            { "string", "string" },
            { "The identfier for the image.", "The URI or name of the target receiving the image." },
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VerifyingAtComponent(Args... args) :
        RedfishMessage(
            "Update.1.0.2.VerifyingAtComponent",
            ...
            2,
            { "string", "string" },
            { "The identfier for the image.", "The URI or name of the target verifying the image." },
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    InstallingOnComponent(Args... args) :
        RedfishMessage(
            "Update.1.0.2.InstallingOnComponent",
            ...
            2,
            { "string", "string" },
            { "The identfier for the image.", "The URI or name of the target installing the image." },
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ApplyingOnComponent(Args... args) :
        RedfishMessage(
            "Update.1.0.2.ApplyingOnComponent",
            ...
            2,
            { "string", "string" },
            { "The identfier for the image.", "The URI or name of the target applying the image." },
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VerificationFailed(Args... args) :
        RedfishMessage(
            "Update.1.0.2.VerificationFailed",
            "Indicates that the component failed to verify an image.",
            "This message shall indicate that the component failed to verify an image.",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActivateFailed(Args... args) :
        RedfishMessage(
            ...
            2,
            { "string", "string" },
            { "The identfier for the image.", "The URI or name of the target activating the image." },
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    AwaitToUpdate(Args... args) :
        RedfishMessage(
            ...
            2,
            { "string", "string" },
            { "The identfier for the image.", "The URI or name of the target awating for an action to install the image." },
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    AwaitToActivate(Args... args) :
        RedfishMessage(
            ...
            2,
            { "string", "string" },
            { "The identfier for the image.", "The URI or name of the target awating for an action to activate the image." },
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    UpdateSuccessful(Args... args) :
        RedfishMessage(
            ...
            2,
            { "string", "string" },
            { "The URI or name of the device that was updated.", "The identfier for the image." },
    ...
    public RedfishMessage<std::string>
{
    ...
    OperationTransitionedToJob(Args... args) :
        RedfishMessage(
            "Update.1.0.2.OperationTransitionedToJob",
