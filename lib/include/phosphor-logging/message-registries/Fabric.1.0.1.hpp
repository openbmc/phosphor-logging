    ...
    public RedfishMessage<std::string, std::string, double>
{
    ...
    MaxFrameSizeExceeded(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.MaxFrameSizeExceeded",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    UpstreamLinkEstablished(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.UpstreamLinkEstablished",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    UpstreamLinkDropped(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.UpstreamLinkDropped",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    DegradedUpstreamLinkEstablished(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.DegradedUpstreamLinkEstablished",
    ...
    public RedfishMessage<std::string, std::string, double, double>
{
    ...
    UpstreamLinkFlapDetected(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.UpstreamLinkFlapDetected",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    DownstreamLinkEstablished(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.DownstreamLinkEstablished",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    DownstreamLinkDropped(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.DownstreamLinkDropped",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    DegradedDownstreamLinkEstablished(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.DegradedDownstreamLinkEstablished",
    ...
    public RedfishMessage<std::string, std::string, double, double>
{
    ...
    DownstreamLinkFlapDetected(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.DownstreamLinkFlapDetected",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    InterswitchLinkEstablished(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.InterswitchLinkEstablished",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    InterswitchLinkDropped(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.InterswitchLinkDropped",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    DegradedInterswitchLinkEstablished(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.DegradedInterswitchLinkEstablished",
    ...
    public RedfishMessage<std::string, std::string, double, double>
{
    ...
    InterswitchLinkFlapDetected(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.InterswitchLinkFlapDetected",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PortManuallyDisabled(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.PortManuallyDisabled",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PortManuallyEnabled(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.PortManuallyEnabled",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PortAutomaticallyDisabled(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.PortAutomaticallyDisabled",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PortAutomaticallyEnabled(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.PortAutomaticallyEnabled",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ConnectionCreated(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.ConnectionCreated",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ConnectionRemoved(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.ConnectionRemoved",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ConnectionModified(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.ConnectionModified",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    AddressPoolCreated(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.AddressPoolCreated",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    AddressPoolRemoved(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.AddressPoolRemoved",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    AddressPoolModified(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.AddressPoolModified",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    MediaControllerAdded(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.MediaControllerAdded",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    MediaControllerRemoved(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.MediaControllerRemoved",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    MediaControllerModified(Args... args) :
        RedfishMessage(
            "Fabric.1.0.1.MediaControllerModified",
