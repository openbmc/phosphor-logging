...
{
namespace License_1_0_3
{

struct LicenseInstalled :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    LicenseInstalled(Args... args) :
        RedfishMessage(
            "License.1.0.3.LicenseInstalled",
...
struct NotApplicableToTarget :
    public RedfishMessage<>
{
    template <typename... Args>
    NotApplicableToTarget(Args... args) :
        RedfishMessage(
            "License.1.0.3.NotApplicableToTarget",
...
struct TargetsRequired :
    public RedfishMessage<>
{
    template <typename... Args>
    TargetsRequired(Args... args) :
        RedfishMessage(
            "License.1.0.3.TargetsRequired",
