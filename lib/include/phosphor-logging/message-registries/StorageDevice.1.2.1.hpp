    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerOK(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.ControllerOK",
    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.ControllerFailure",
    ...
    public RedfishMessage<std::string>
{
    ...
    DrivePredictiveFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.DrivePredictiveFailure",
    ...
    public RedfishMessage<std::string>
{
    ...
    DrivePredictiveFailureCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.DrivePredictiveFailureCleared",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.DriveFailure",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveFailureCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.DriveFailureCleared",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveInserted(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.DriveInserted",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveRemoved(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.DriveRemoved",
            "A drive was removed.",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VolumeDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.VolumeDegraded",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VolumeFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.VolumeFailure",
    ...
    public RedfishMessage<std::string>
{
    ...
    WriteCacheProtected(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.WriteCacheProtected",
    ...
    public RedfishMessage<std::string>
{
    ...
    WriteCacheTemporarilyDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.WriteCacheTemporarilyDegraded",
    ...
    public RedfishMessage<std::string>
{
    ...
    WriteCacheDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.WriteCacheDegraded",
    ...
    public RedfishMessage<std::string>
{
    ...
    WriteCacheDataLoss(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.WriteCacheDataLoss",
    ...
    public RedfishMessage<std::string>
{
    ...
    BatteryCharging(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.BatteryCharging",
    ...
    public RedfishMessage<std::string>
{
    ...
    BatteryMissing(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.BatteryMissing",
    ...
    public RedfishMessage<std::string>
{
    ...
    BatteryFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.BatteryFailure",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ControllerDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.ControllerDegraded",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ControllerPreviousError(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.ControllerPreviousError",
    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerPasswordAccepted(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.ControllerPasswordAccepted",
    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerPasswordRequired(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.ControllerPasswordRequired",
    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerPortOK(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.ControllerPortOK",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ControllerPortDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.ControllerPortDegraded",
    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerPortFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.ControllerPortFailure",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveMissing(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.DriveMissing",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveMissingCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.DriveMissingCleared",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveOffline(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.DriveOffline",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveOfflineCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.DriveOfflineCleared",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VolumeOffline(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.VolumeOffline",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VolumeOffine(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.VolumeOffine",
            "The storage controller has detected an offline volume condition.",
            "This message shall indicate a volume offline condition was detected.  This may occur if the volume configuration is not supported or needs to be imported.",
            "The volume '%1' attached to the storage controller located in '%2' is offline.",
            "Critical",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VolumeOfflineCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.2.1.VolumeOfflineCleared",
