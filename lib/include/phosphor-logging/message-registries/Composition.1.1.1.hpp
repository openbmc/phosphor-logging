    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceBlockChanged(Args... args) :
        RedfishMessage(
            "Composition.1.1.1.ResourceBlockChanged",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceBlockStateChanged(Args... args) :
        RedfishMessage(
            "Composition.1.1.1.ResourceBlockStateChanged",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceBlockCompositionStateChanged(Args... args) :
        RedfishMessage(
            "Composition.1.1.1.ResourceBlockCompositionStateChanged",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceZoneMembershipChanged(Args... args) :
        RedfishMessage(
            "Composition.1.1.1.ResourceZoneMembershipChanged",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceBlockInUse(Args... args) :
        RedfishMessage(
            "Composition.1.1.1.ResourceBlockInUse",
    ...
    public RedfishMessage<>
{
    ...
    EmptyManifest(Args... args) :
        RedfishMessage(
            "Composition.1.1.1.EmptyManifest",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    UnableToProcessStanzaRequest(Args... args) :
        RedfishMessage(
            "Composition.1.1.1.UnableToProcessStanzaRequest",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceBlockInvalid(Args... args) :
        RedfishMessage(
            "Composition.1.1.1.ResourceBlockInvalid",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceBlockNotFound(Args... args) :
        RedfishMessage(
            "Composition.1.1.1.ResourceBlockNotFound",
    ...
    public RedfishMessage<std::string>
{
    ...
    NoResourceMatch(Args... args) :
        RedfishMessage(
            "Composition.1.1.1.NoResourceMatch",
    ...
    public RedfishMessage<>
{
    ...
    IncompatibleZone(Args... args) :
        RedfishMessage(
            "Composition.1.1.1.IncompatibleZone",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    SpecifiedResourceAlreadyReserved(Args... args) :
        RedfishMessage(
            "Composition.1.1.1.SpecifiedResourceAlreadyReserved",
    ...
    public RedfishMessage<std::string>
{
    ...
    ConstrainedResourceAlreadyReserved(Args... args) :
        RedfishMessage(
            "Composition.1.1.1.ConstrainedResourceAlreadyReserved",
