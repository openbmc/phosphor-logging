    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueTypeError(Args... args) :
        RedfishMessage(
            "Base.1.8.2.PropertyValueTypeError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.8.2.PropertyValueFormatError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueNotInList(Args... args) :
        RedfishMessage(
            "Base.1.8.2.PropertyValueNotInList",
    ...
    public RedfishMessage<std::string>
{
    ...
    PropertyNotWritable(Args... args) :
        RedfishMessage(
            "Base.1.8.2.PropertyNotWritable",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterMissing(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ActionParameterMissing",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterDuplicate(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ActionParameterDuplicate",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterUnknown(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ActionParameterUnknown",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ActionParameterValueTypeError(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ActionParameterValueTypeError",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ActionParameterValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ActionParameterValueFormatError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterNotSupported(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ActionParameterNotSupported",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    QueryParameterValueTypeError(Args... args) :
        RedfishMessage(
            "Base.1.8.2.QueryParameterValueTypeError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    QueryParameterValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.8.2.QueryParameterValueFormatError",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    QueryParameterOutOfRange(Args... args) :
        RedfishMessage(
            "Base.1.8.2.QueryParameterOutOfRange",
    ...
    public RedfishMessage<>
{
    ...
    QueryNotSupportedOnResource(Args... args) :
        RedfishMessage(
            "Base.1.8.2.QueryNotSupportedOnResource",
    ...
    public RedfishMessage<>
{
    ...
    QueryNotSupportedOnOperation(Args... args) :
        RedfishMessage(
            "Base.1.8.2.QueryNotSupportedOnOperation",
    ...
    public RedfishMessage<>
{
    ...
    QueryCombinationInvalid(Args... args) :
        RedfishMessage(
            "Base.1.8.2.QueryCombinationInvalid",
    ...
    public RedfishMessage<>
{
    ...
    SessionLimitExceeded(Args... args) :
        RedfishMessage(
            "Base.1.8.2.SessionLimitExceeded",
    ...
    public RedfishMessage<>
{
    ...
    EventSubscriptionLimitExceeded(Args... args) :
        RedfishMessage(
            "Base.1.8.2.EventSubscriptionLimitExceeded",
    ...
    public RedfishMessage<>
{
    ...
    ResourceCannotBeDeleted(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ResourceCannotBeDeleted",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ResourceAlreadyExists(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ResourceAlreadyExists",
    ...
    public RedfishMessage<std::string>
{
    ...
    CreateFailedMissingReqProperties(Args... args) :
        RedfishMessage(
            "Base.1.8.2.CreateFailedMissingReqProperties",
    ...
    public RedfishMessage<>
{
    ...
    CreateLimitReachedForResource(Args... args) :
        RedfishMessage(
            "Base.1.8.2.CreateLimitReachedForResource",
    ...
    public RedfishMessage<>
{
    ...
    ServiceShuttingDown(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ServiceShuttingDown",
    ...
    public RedfishMessage<>
{
    ...
    ServiceInUnknownState(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ServiceInUnknownState",
    ...
    public RedfishMessage<>
{
    ...
    InsufficientPrivilege(Args... args) :
        RedfishMessage(
            "Base.1.8.2.InsufficientPrivilege",
    ...
    public RedfishMessage<>
{
    ...
    AccountForSessionNoLongerExists(Args... args) :
        RedfishMessage(
            "Base.1.8.2.AccountForSessionNoLongerExists",
    ...
    public RedfishMessage<>
{
    ...
    UnrecognizedRequestBody(Args... args) :
        RedfishMessage(
            "Base.1.8.2.UnrecognizedRequestBody",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceMissingAtURI(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ResourceMissingAtURI",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceAtUriInUnknownFormat(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ResourceAtUriInUnknownFormat",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceAtUriUnauthorized(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ResourceAtUriUnauthorized",
    ...
    public RedfishMessage<std::string>
{
    ...
    CouldNotEstablishConnection(Args... args) :
        RedfishMessage(
            "Base.1.8.2.CouldNotEstablishConnection",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    SourceDoesNotSupportProtocol(Args... args) :
        RedfishMessage(
            "Base.1.8.2.SourceDoesNotSupportProtocol",
    ...
    public RedfishMessage<std::string>
{
    ...
    ServiceTemporarilyUnavailable(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ServiceTemporarilyUnavailable",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueModified(Args... args) :
        RedfishMessage(
            "Base.1.8.2.PropertyValueModified",
    ...
    public RedfishMessage<>
{
    ...
    SubscriptionTerminated(Args... args) :
        RedfishMessage(
            "Base.1.8.2.SubscriptionTerminated",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceTypeIncompatible(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ResourceTypeIncompatible",
    ...
    public RedfishMessage<std::string>
{
    ...
    PasswordChangeRequired(Args... args) :
        RedfishMessage(
            "Base.1.8.2.PasswordChangeRequired",
    ...
    public RedfishMessage<std::string>
{
    ...
    ChassisPowerStateOnRequired(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ChassisPowerStateOnRequired",
    ...
    public RedfishMessage<std::string>
{
    ...
    ChassisPowerStateOffRequired(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ChassisPowerStateOffRequired",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueConflict(Args... args) :
        RedfishMessage(
            "Base.1.8.2.PropertyValueConflict",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueIncorrect(Args... args) :
        RedfishMessage(
            "Base.1.8.2.PropertyValueIncorrect",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceCreationConflict(Args... args) :
        RedfishMessage(
            "Base.1.8.2.ResourceCreationConflict",
    ...
    public RedfishMessage<>
{
    ...
    MaximumErrorsExceeded(Args... args) :
        RedfishMessage(
            "Base.1.8.2.MaximumErrorsExceeded",
    ...
    public RedfishMessage<>
{
    ...
    PreconditionRequired(Args... args) :
        RedfishMessage(
            "Base.1.8.2.PreconditionRequired",
