    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerOK(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.ControllerOK",
    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.ControllerFailure",
    ...
    public RedfishMessage<std::string>
{
    ...
    DrivePredictiveFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.DrivePredictiveFailure",
    ...
    public RedfishMessage<std::string>
{
    ...
    DrivePredictiveFailureCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.DrivePredictiveFailureCleared",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.DriveFailure",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveFailureCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.DriveFailureCleared",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveInserted(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.DriveInserted",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveRemoved(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.DriveRemoved",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VolumeDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.VolumeDegraded",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VolumeFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.VolumeFailure",
    ...
    public RedfishMessage<std::string>
{
    ...
    WriteCacheProtected(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.WriteCacheProtected",
    ...
    public RedfishMessage<std::string>
{
    ...
    WriteCacheTemporarilyDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.WriteCacheTemporarilyDegraded",
    ...
    public RedfishMessage<std::string>
{
    ...
    WriteCacheDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.WriteCacheDegraded",
    ...
    public RedfishMessage<std::string>
{
    ...
    WriteCacheDataLoss(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.WriteCacheDataLoss",
    ...
    public RedfishMessage<std::string>
{
    ...
    BatteryCharging(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.BatteryCharging",
    ...
    public RedfishMessage<std::string>
{
    ...
    BatteryMissing(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.BatteryMissing",
    ...
    public RedfishMessage<std::string>
{
    ...
    BatteryFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.BatteryFailure",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ControllerDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.ControllerDegraded",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ControllerPreviousError(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.ControllerPreviousError",
    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerPasswordAccepted(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.ControllerPasswordAccepted",
    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerPasswordRequired(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.ControllerPasswordRequired",
    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerPortOK(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.ControllerPortOK",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ControllerPortDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.ControllerPortDegraded",
    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerPortFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.ControllerPortFailure",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveMissing(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.DriveMissing",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveMissingCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.DriveMissingCleared",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveOffline(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.DriveOffline",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveOfflineCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.DriveOfflineCleared",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VolumeOffine(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.VolumeOffine",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VolumeOfflineCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.1.0.VolumeOfflineCleared",
