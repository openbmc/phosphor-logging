    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueTypeError(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PropertyValueTypeError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PropertyValueFormatError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueNotInList(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PropertyValueNotInList",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueOutOfRange(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PropertyValueOutOfRange",
    ...
    public RedfishMessage<std::string>
{
    ...
    PropertyValueError(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PropertyValueError",
    ...
    public RedfishMessage<std::string>
{
    ...
    PropertyNotWritable(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PropertyNotWritable",
    ...
    public RedfishMessage<std::string>
{
    ...
    PropertyNotUpdated(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PropertyNotUpdated",
    ...
    public RedfishMessage<std::string>
{
    ...
    ActionNotSupported(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ActionNotSupported",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterMissing(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ActionParameterMissing",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterDuplicate(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ActionParameterDuplicate",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterUnknown(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ActionParameterUnknown",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ActionParameterValueTypeError(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ActionParameterValueTypeError",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ActionParameterValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ActionParameterValueFormatError",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ActionParameterValueNotInList(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ActionParameterValueNotInList",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterValueError(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ActionParameterValueError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterNotSupported(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ActionParameterNotSupported",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    QueryParameterValueTypeError(Args... args) :
        RedfishMessage(
            "Base.1.17.0.QueryParameterValueTypeError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    QueryParameterValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.17.0.QueryParameterValueFormatError",
    ...
    public RedfishMessage<std::string>
{
    ...
    QueryParameterValueError(Args... args) :
        RedfishMessage(
            "Base.1.17.0.QueryParameterValueError",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    QueryParameterOutOfRange(Args... args) :
        RedfishMessage(
            "Base.1.17.0.QueryParameterOutOfRange",
    ...
    public RedfishMessage<>
{
    ...
    QueryNotSupportedOnResource(Args... args) :
        RedfishMessage(
            "Base.1.17.0.QueryNotSupportedOnResource",
    ...
    public RedfishMessage<>
{
    ...
    QueryNotSupportedOnOperation(Args... args) :
        RedfishMessage(
            "Base.1.17.0.QueryNotSupportedOnOperation",
    ...
    public RedfishMessage<>
{
    ...
    QueryCombinationInvalid(Args... args) :
        RedfishMessage(
            "Base.1.17.0.QueryCombinationInvalid",
    ...
    public RedfishMessage<std::string>
{
    ...
    QueryParameterUnsupported(Args... args) :
        RedfishMessage(
            "Base.1.17.0.QueryParameterUnsupported",
    ...
    public RedfishMessage<>
{
    ...
    SessionLimitExceeded(Args... args) :
        RedfishMessage(
            "Base.1.17.0.SessionLimitExceeded",
    ...
    public RedfishMessage<>
{
    ...
    EventSubscriptionLimitExceeded(Args... args) :
        RedfishMessage(
            "Base.1.17.0.EventSubscriptionLimitExceeded",
    ...
    public RedfishMessage<>
{
    ...
    ResourceCannotBeDeleted(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ResourceCannotBeDeleted",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ResourceAlreadyExists(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ResourceAlreadyExists",
    ...
    public RedfishMessage<>
{
    ...
    InsufficientStorage(Args... args) :
        RedfishMessage(
            "Base.1.17.0.InsufficientStorage",
    ...
    public RedfishMessage<>
{
    ...
    MissingOrMalformedPart(Args... args) :
        RedfishMessage(
            "Base.1.17.0.MissingOrMalformedPart",
    ...
    public RedfishMessage<std::string>
{
    ...
    CreateFailedMissingReqProperties(Args... args) :
        RedfishMessage(
            "Base.1.17.0.CreateFailedMissingReqProperties",
    ...
    public RedfishMessage<>
{
    ...
    CreateLimitReachedForResource(Args... args) :
        RedfishMessage(
            "Base.1.17.0.CreateLimitReachedForResource",
    ...
    public RedfishMessage<>
{
    ...
    ServiceShuttingDown(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ServiceShuttingDown",
    ...
    public RedfishMessage<>
{
    ...
    ServiceInUnknownState(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ServiceInUnknownState",
    ...
    public RedfishMessage<>
{
    ...
    InsufficientPrivilege(Args... args) :
        RedfishMessage(
            "Base.1.17.0.InsufficientPrivilege",
    ...
    public RedfishMessage<>
{
    ...
    AccountNotModified(Args... args) :
        RedfishMessage(
            "Base.1.17.0.AccountNotModified",
    ...
    public RedfishMessage<>
{
    ...
    AccountForSessionNoLongerExists(Args... args) :
        RedfishMessage(
            "Base.1.17.0.AccountForSessionNoLongerExists",
    ...
    public RedfishMessage<>
{
    ...
    UnrecognizedRequestBody(Args... args) :
        RedfishMessage(
            "Base.1.17.0.UnrecognizedRequestBody",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceMissingAtURI(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ResourceMissingAtURI",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceAtUriInUnknownFormat(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ResourceAtUriInUnknownFormat",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceAtUriUnauthorized(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ResourceAtUriUnauthorized",
    ...
    public RedfishMessage<std::string>
{
    ...
    CouldNotEstablishConnection(Args... args) :
        RedfishMessage(
            "Base.1.17.0.CouldNotEstablishConnection",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    SourceDoesNotSupportProtocol(Args... args) :
        RedfishMessage(
            "Base.1.17.0.SourceDoesNotSupportProtocol",
    ...
    public RedfishMessage<std::string>
{
    ...
    ServiceTemporarilyUnavailable(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ServiceTemporarilyUnavailable",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueModified(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PropertyValueModified",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceExhaustion(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ResourceExhaustion",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    StringValueTooLong(Args... args) :
        RedfishMessage(
            "Base.1.17.0.StringValueTooLong",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    StringValueTooShort(Args... args) :
        RedfishMessage(
            "Base.1.17.0.StringValueTooShort",
    ...
    public RedfishMessage<>
{
    ...
    SubscriptionTerminated(Args... args) :
        RedfishMessage(
            "Base.1.17.0.SubscriptionTerminated",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceTypeIncompatible(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ResourceTypeIncompatible",
    ...
    public RedfishMessage<std::string>
{
    ...
    PasswordChangeRequired(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PasswordChangeRequired",
    ...
    public RedfishMessage<std::string>
{
    ...
    ChassisPowerStateOnRequired(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ChassisPowerStateOnRequired",
    ...
    public RedfishMessage<std::string>
{
    ...
    ChassisPowerStateOffRequired(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ChassisPowerStateOffRequired",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueConflict(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PropertyValueConflict",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    PropertyValueResourceConflict(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PropertyValueResourceConflict",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueExternalConflict(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PropertyValueExternalConflict",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueIncorrect(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PropertyValueIncorrect",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceCreationConflict(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ResourceCreationConflict",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterValueConflict(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ActionParameterValueConflict",
    ...
    public RedfishMessage<>
{
    ...
    MaximumErrorsExceeded(Args... args) :
        RedfishMessage(
            "Base.1.17.0.MaximumErrorsExceeded",
    ...
    public RedfishMessage<>
{
    ...
    PreconditionFailed(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PreconditionFailed",
    ...
    public RedfishMessage<>
{
    ...
    PreconditionRequired(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PreconditionRequired",
    ...
    public RedfishMessage<>
{
    ...
    OperationNotAllowed(Args... args) :
        RedfishMessage(
            "Base.1.17.0.OperationNotAllowed",
    ...
    public RedfishMessage<>
{
    ...
    ConditionInRelatedResource(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ConditionInRelatedResource",
    ...
    public RedfishMessage<std::string>
{
    ...
    RestrictedPrivilege(Args... args) :
        RedfishMessage(
            "Base.1.17.0.RestrictedPrivilege",
    ...
    public RedfishMessage<std::string>
{
    ...
    StrictAccountTypes(Args... args) :
        RedfishMessage(
            "Base.1.17.0.StrictAccountTypes",
    ...
    public RedfishMessage<std::string>
{
    ...
    PropertyDeprecated(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PropertyDeprecated",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceDeprecated(Args... args) :
        RedfishMessage(
            "Base.1.17.0.ResourceDeprecated",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueDeprecated(Args... args) :
        RedfishMessage(
            "Base.1.17.0.PropertyValueDeprecated",
    ...
    public RedfishMessage<>
{
    ...
    NetworkNameResolutionNotConfigured(Args... args) :
        RedfishMessage(
            "Base.1.17.0.NetworkNameResolutionNotConfigured",
    ...
    public RedfishMessage<>
{
    ...
    NetworkNameResolutionNotSupported(Args... args) :
        RedfishMessage(
            "Base.1.17.0.NetworkNameResolutionNotSupported",
    ...
    public RedfishMessage<>
{
    ...
    EventBufferExceeded(Args... args) :
        RedfishMessage(
            "Base.1.17.0.EventBufferExceeded",
    ...
    public RedfishMessage<>
{
    ...
    AuthenticationTokenRequired(Args... args) :
        RedfishMessage(
            "Base.1.17.0.AuthenticationTokenRequired",
    ...
    public RedfishMessage<std::string>
{
    ...
    OneTimePasscodeSent(Args... args) :
        RedfishMessage(
            "Base.1.17.0.OneTimePasscodeSent",
            "Indicates that a required one-time passcode has been sent to the user.  The code should be provided as the `Token` property in the request to create a session.",
            "This message shall be used to indicate that a one-time passcode has been generated by the service as the result of a request to create a session.  The one-time passcode shall be sent to the delivery address associated with account credentials supplied in the request.",
            "A one-time passcode has been sent to: %1.  Supply the passcode as the Token property in the request to create a session.",
            "OK",
            1,
            { "string" },
