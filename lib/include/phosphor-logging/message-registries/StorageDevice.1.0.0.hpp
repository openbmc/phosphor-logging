    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerOK(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.ControllerOK",
            "The storage controller status has changed to OK.",
            "This message shall be used to indicate that the storage controller status has changed to OK.",
            "The status of the storage controller located in '%1' has changed to OK.",
            "OK",
            1,
            { "string" },
    ...
    public RedfishMessage<std::string>
{
    ...
    ControllerFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.ControllerFailure",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveOK(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.DriveOK",
            "The status of a physical drive has changed to OK.",
            "This message shall be used to indicate a drive status has changed to OK.",
            "The status of the drive located in '%1' has changed to OK.",
            "OK",
            1,
            { "string" },
    ...
    public RedfishMessage<std::string>
{
    ...
    DrivePredictiveFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.DrivePredictiveFailure",
            ...
            { "The location of the drive." },
            { "The value of this argument shall be a string containing the drive location." },
            "If this drive is not part of a fault-tolerant volume, first back up all data, then replace the drive and restore all data afterward.  If this drive is part of a fault-tolerant volume, replace this drive as soon as possible as long as the volume status is OK.",
            std::make_tuple(std::forward<Args>(args)...))
    {}
};
    ...
    public RedfishMessage<std::string>
{
    ...
    DrivePredictiveFailureCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.DrivePredictiveFailureCleared",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.DriveFailure",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveFailureCleared(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.DriveFailureCleared",
    ...
    public RedfishMessage<std::string>
{
    ...
    DriveRemoved(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.DriveRemoved",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VolumeOK(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.VolumeOK",
            "A volume status has changed to OK.",
            "This message shall be used to indicate a volume status has changed to OK.",
            "The status of volume '%1' that is attached to the storage controller located in '%2' has changed to OK.",
            "OK",
            2,
            { "string", "string" },
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VolumeDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.VolumeDegraded",
            ...
            "The volume '%1' attached to the storage controller located in '%2' is in degraded state.",
            "Warning",
            2,
            { "string", "string" },
            { "The identifier of the volume.", "The location of the storage controller." },
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VolumeFailure(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.VolumeFailure",
    ...
    public RedfishMessage<std::string>
{
    ...
    WriteCacheProtected(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.WriteCacheProtected",
    ...
    public RedfishMessage<std::string>
{
    ...
    WriteCacheTemporarilyDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.WriteCacheTemporarilyDegraded",
    ...
    public RedfishMessage<std::string>
{
    ...
    WriteCacheDegraded(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.WriteCacheDegraded",
    ...
    public RedfishMessage<std::string>
{
    ...
    WriteCacheDataLoss(Args... args) :
        RedfishMessage(
            "StorageDevice.1.0.0.WriteCacheDataLoss",
