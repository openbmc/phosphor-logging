    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    CableInserted(Args... args) :
        RedfishMessage(
            "NetworkDevice.1.0.0.CableInserted",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    CableRemoved(Args... args) :
        RedfishMessage(
            "NetworkDevice.1.0.0.CableRemoved",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ConnectionDropped(Args... args) :
        RedfishMessage(
            "NetworkDevice.1.0.0.ConnectionDropped",
            ...
            { "The value of this argument shall be a string containing the value of the Name property of network adapter from which a connection has dropped.", "The value of this argument shall be a string containing the value of the Name property of network port from which a connection has dropped.", "The value of this argument shall be a string containing the value of the Name property of network device function from which a connection has dropped." },
            "Refresh your cached version of the network port to get the updated information from the service.",
            std::make_tuple(std::forward<Args>(args)...))
    {}
};
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ConnectionEstablished(Args... args) :
        RedfishMessage(
            "NetworkDevice.1.0.0.ConnectionEstablished",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    DegradedConnectionEstablished(Args... args) :
        RedfishMessage(
            "NetworkDevice.1.0.0.DegradedConnectionEstablished",
    ...
    public RedfishMessage<std::string, std::string, std::string, double, double>
{
    ...
    LinkFlapDetected(Args... args) :
        RedfishMessage(
            "NetworkDevice.1.0.0.LinkFlapDetected",
