    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueTypeError(Args... args) :
        RedfishMessage(
            "Base.1.7.0.PropertyValueTypeError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.7.0.PropertyValueFormatError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueNotInList(Args... args) :
        RedfishMessage(
            "Base.1.7.0.PropertyValueNotInList",
    ...
    public RedfishMessage<std::string>
{
    ...
    PropertyNotWritable(Args... args) :
        RedfishMessage(
            "Base.1.7.0.PropertyNotWritable",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterMissing(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ActionParameterMissing",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterDuplicate(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ActionParameterDuplicate",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterUnknown(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ActionParameterUnknown",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ActionParameterValueTypeError(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ActionParameterValueTypeError",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ActionParameterValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ActionParameterValueFormatError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ActionParameterNotSupported(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ActionParameterNotSupported",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    QueryParameterValueTypeError(Args... args) :
        RedfishMessage(
            "Base.1.7.0.QueryParameterValueTypeError",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    QueryParameterValueFormatError(Args... args) :
        RedfishMessage(
            "Base.1.7.0.QueryParameterValueFormatError",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    QueryParameterOutOfRange(Args... args) :
        RedfishMessage(
            "Base.1.7.0.QueryParameterOutOfRange",
    ...
    public RedfishMessage<>
{
    ...
    QueryNotSupportedOnResource(Args... args) :
        RedfishMessage(
            "Base.1.7.0.QueryNotSupportedOnResource",
    ...
    public RedfishMessage<>
{
    ...
    QueryNotSupportedOnOperation(Args... args) :
        RedfishMessage(
            "Base.1.7.0.QueryNotSupportedOnOperation",
    ...
    public RedfishMessage<>
{
    ...
    QueryCombinationInvalid(Args... args) :
        RedfishMessage(
            "Base.1.7.0.QueryCombinationInvalid",
    ...
    public RedfishMessage<>
{
    ...
    SessionLimitExceeded(Args... args) :
        RedfishMessage(
            "Base.1.7.0.SessionLimitExceeded",
    ...
    public RedfishMessage<>
{
    ...
    EventSubscriptionLimitExceeded(Args... args) :
        RedfishMessage(
            "Base.1.7.0.EventSubscriptionLimitExceeded",
    ...
    public RedfishMessage<>
{
    ...
    ResourceCannotBeDeleted(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ResourceCannotBeDeleted",
    ...
    public RedfishMessage<std::string, std::string, std::string>
{
    ...
    ResourceAlreadyExists(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ResourceAlreadyExists",
    ...
    public RedfishMessage<std::string>
{
    ...
    CreateFailedMissingReqProperties(Args... args) :
        RedfishMessage(
            "Base.1.7.0.CreateFailedMissingReqProperties",
    ...
    public RedfishMessage<>
{
    ...
    CreateLimitReachedForResource(Args... args) :
        RedfishMessage(
            "Base.1.7.0.CreateLimitReachedForResource",
    ...
    public RedfishMessage<>
{
    ...
    ServiceShuttingDown(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ServiceShuttingDown",
    ...
    public RedfishMessage<>
{
    ...
    ServiceInUnknownState(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ServiceInUnknownState",
    ...
    public RedfishMessage<>
{
    ...
    InsufficientPrivilege(Args... args) :
        RedfishMessage(
            "Base.1.7.0.InsufficientPrivilege",
    ...
    public RedfishMessage<>
{
    ...
    AccountForSessionNoLongerExists(Args... args) :
        RedfishMessage(
            "Base.1.7.0.AccountForSessionNoLongerExists",
    ...
    public RedfishMessage<>
{
    ...
    UnrecognizedRequestBody(Args... args) :
        RedfishMessage(
            "Base.1.7.0.UnrecognizedRequestBody",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceMissingAtURI(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ResourceMissingAtURI",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceAtUriInUnknownFormat(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ResourceAtUriInUnknownFormat",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceAtUriUnauthorized(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ResourceAtUriUnauthorized",
    ...
    public RedfishMessage<std::string>
{
    ...
    CouldNotEstablishConnection(Args... args) :
        RedfishMessage(
            "Base.1.7.0.CouldNotEstablishConnection",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    SourceDoesNotSupportProtocol(Args... args) :
        RedfishMessage(
            "Base.1.7.0.SourceDoesNotSupportProtocol",
    ...
    public RedfishMessage<std::string>
{
    ...
    ServiceTemporarilyUnavailable(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ServiceTemporarilyUnavailable",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueModified(Args... args) :
        RedfishMessage(
            "Base.1.7.0.PropertyValueModified",
    ...
    public RedfishMessage<>
{
    ...
    SubscriptionTerminated(Args... args) :
        RedfishMessage(
            "Base.1.7.0.SubscriptionTerminated",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceTypeIncompatible(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ResourceTypeIncompatible",
    ...
    public RedfishMessage<std::string>
{
    ...
    PasswordChangeRequired(Args... args) :
        RedfishMessage(
            "Base.1.7.0.PasswordChangeRequired",
    ...
    public RedfishMessage<std::string>
{
    ...
    ChassisPowerStateOnRequired(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ChassisPowerStateOnRequired",
    ...
    public RedfishMessage<std::string>
{
    ...
    ChassisPowerStateOffRequired(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ChassisPowerStateOffRequired",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueConflict(Args... args) :
        RedfishMessage(
            "Base.1.7.0.PropertyValueConflict",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueIncorrect(Args... args) :
        RedfishMessage(
            "Base.1.7.0.PropertyValueIncorrect",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceCreationConflict(Args... args) :
        RedfishMessage(
            "Base.1.7.0.ResourceCreationConflict",
