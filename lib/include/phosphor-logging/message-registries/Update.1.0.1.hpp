    ...
    public RedfishMessage<>
{
    ...
    AllTargetsDetermined(Args... args) :
        RedfishMessage(
            "Update.1.0.1.AllTargetsDetermined",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    TransferringToComponent(Args... args) :
        RedfishMessage(
            "Update.1.0.1.TransferringToComponent",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VerifyingAtComponent(Args... args) :
        RedfishMessage(
            "Update.1.0.1.VerifyingAtComponent",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    InstallingOnComponent(Args... args) :
        RedfishMessage(
            "Update.1.0.1.InstallingOnComponent",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ApplyingOnComponent(Args... args) :
        RedfishMessage(
            "Update.1.0.1.ApplyingOnComponent",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    VerificationFailed(Args... args) :
        RedfishMessage(
            "Update.1.0.1.VerificationFailed",
    ...
    public RedfishMessage<std::string>
{
    ...
    OperationTransitionedToJob(Args... args) :
        RedfishMessage(
            "Update.1.0.1.OperationTransitionedToJob",
