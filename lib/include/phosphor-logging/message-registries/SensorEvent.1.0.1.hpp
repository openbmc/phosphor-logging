...
{
namespace SensorEvent_1_0_1
{

struct ReadingAboveUpperCautionThreshold :
    public RedfishMessage<std::string, double, std::string, double>
{
    template <typename... Args>
    ReadingAboveUpperCautionThreshold(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.ReadingAboveUpperCautionThreshold",
            "Indicates that a sensor reading is above the upper caution threshold.",
            "This message shall indicate that the value of the `Reading` property in a `Sensor` resource is above the value of the `Reading` property within the `UpperCaution` or `UpperCautionUser` properties.",
...
struct ReadingAboveUpperCriticalThreshold :
    public RedfishMessage<std::string, double, std::string, double>
{
    template <typename... Args>
    ReadingAboveUpperCriticalThreshold(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.ReadingAboveUpperCriticalThreshold",
            "Indicates that a sensor reading is above the upper critical threshold.",
            "This message shall indicate that the value of the `Reading` property in a `Sensor` resource is above the value of the `Reading` property within the `UpperCritical` or `UpperCriticalUser` properties.",
...
struct ReadingAboveUpperFatalThreshold :
    public RedfishMessage<std::string, double, std::string, double>
{
    template <typename... Args>
    ReadingAboveUpperFatalThreshold(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.ReadingAboveUpperFatalThreshold",
            "Indicates that a sensor reading is above the upper fatal threshold.",
            "This message shall indicate that the value of the `Reading` property in a `Sensor` resource is above the value of the `Reading` property within the `UpperFatal` property.",
...
struct ReadingBelowLowerCautionThreshold :
    public RedfishMessage<std::string, double, std::string, double>
{
    template <typename... Args>
    ReadingBelowLowerCautionThreshold(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.ReadingBelowLowerCautionThreshold",
            "Indicates that a sensor reading is below the lower caution threshold.",
            "This message shall indicate that the value of the `Reading` property in a `Sensor` resource is below the value of the `Reading` property within the `LowerCaution` or `LowerCautionUser` properties.",
...
struct ReadingBelowLowerCriticalThreshold :
    public RedfishMessage<std::string, double, std::string, double>
{
    template <typename... Args>
    ReadingBelowLowerCriticalThreshold(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.ReadingBelowLowerCriticalThreshold",
            "Indicates that a sensor reading is below the lower critical threshold.",
            "This message shall indicate that the value of the `Reading` property in a `Sensor` resource is below the value of the `Reading` property within the `LowerCritical` or `LowerCriticalUser` properties.",
...
struct ReadingBelowLowerFatalThreshold :
    public RedfishMessage<std::string, double, std::string, double>
{
    template <typename... Args>
    ReadingBelowLowerFatalThreshold(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.ReadingBelowLowerFatalThreshold",
            "Indicates that a sensor reading is below the lower fatal threshold.",
            "This message shall indicate that the value of the `Reading` property in a `Sensor` resource is below the value of the `Reading` property within the `LowerFatal` property.",
...
struct ReadingBelowUpperFatalThreshold :
    public RedfishMessage<std::string, double, std::string, double>
{
    template <typename... Args>
    ReadingBelowUpperFatalThreshold(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.ReadingBelowUpperFatalThreshold",
...
struct ReadingBelowUpperCriticalThreshold :
    public RedfishMessage<std::string, double, std::string, double>
{
    template <typename... Args>
    ReadingBelowUpperCriticalThreshold(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.ReadingBelowUpperCriticalThreshold",
...
struct ReadingAboveLowerFatalThreshold :
    public RedfishMessage<std::string, double, std::string, double>
{
    template <typename... Args>
    ReadingAboveLowerFatalThreshold(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.ReadingAboveLowerFatalThreshold",
...
struct ReadingAboveLowerCriticalThreshold :
    public RedfishMessage<std::string, double, std::string, double>
{
    template <typename... Args>
    ReadingAboveLowerCriticalThreshold(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.ReadingAboveLowerCriticalThreshold",
...
struct ReadingCritical :
    public RedfishMessage<std::string, double, std::string>
{
    template <typename... Args>
    ReadingCritical(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.ReadingCritical",
...
struct ReadingNoLongerCritical :
    public RedfishMessage<std::string, double, std::string>
{
    template <typename... Args>
    ReadingNoLongerCritical(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.ReadingNoLongerCritical",
...
struct SensorReadingNormalRange :
    public RedfishMessage<std::string, double, std::string>
{
    template <typename... Args>
    SensorReadingNormalRange(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.SensorReadingNormalRange",
            "Indicates that a sensor reading is now within normal operating range.",
            "This message shall indicate that the value of the `Reading` property within a `Sensor` resource has returned to its normal operating range.",
...
struct InvalidSensorReading :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    InvalidSensorReading(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.InvalidSensorReading",
            "Indicates that the service received an invalid reading from a sensor.",
            "This message shall indicate that the service received invalid data while attempting to update the value of the `Reading` property in a `Sensor` resource.",
    ...
    public RedfishMessage<std::string>
{
    ...
    SensorFailure(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.SensorFailure",
...
struct SensorRestored :
    public RedfishMessage<std::string>
{
    template <typename... Args>
    SensorRestored(Args... args) :
        RedfishMessage(
            "SensorEvent.1.0.1.SensorRestored",
