    ...
    public RedfishMessage<>
{
    ...
    ResourceCreated(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceCreated",
    ...
    public RedfishMessage<>
{
    ...
    ResourceRemoved(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceRemoved",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceErrorsDetected(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceErrorsDetected",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceErrorsCorrected(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceErrorsCorrected",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    ResourceErrorThresholdExceeded(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceErrorThresholdExceeded",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    ResourceErrorThresholdCleared(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceErrorThresholdCleared",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    ResourceWarningThresholdExceeded(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceWarningThresholdExceeded",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    ResourceWarningThresholdCleared(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceWarningThresholdCleared",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceStatusChangedOK(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceStatusChangedOK",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceStatusChangedWarning(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceStatusChangedWarning",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceStatusChangedCritical(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceStatusChangedCritical",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    ResourceStateChanged(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceStateChanged",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourcePoweredOn(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourcePoweredOn",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourcePoweringOn(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourcePoweringOn",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourcePoweredOff(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourcePoweredOff",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourcePoweringOff(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourcePoweringOff",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourcePaused(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourcePaused",
    ...
    public RedfishMessage<>
{
    ...
    URIForResourceChanged(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.URIForResourceChanged",
    ...
    public RedfishMessage<>
{
    ...
    ResourceChanged(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceChanged",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    PropertyValueModifiedByClient(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.PropertyValueModifiedByClient",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceVersionIncompatible(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceVersionIncompatible",
    ...
    public RedfishMessage<std::string>
{
    ...
    ResourceSelfTestFailed(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceSelfTestFailed",
    ...
    public RedfishMessage<>
{
    ...
    ResourceSelfTestCompleted(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.ResourceSelfTestCompleted",
    ...
    public RedfishMessage<>
{
    ...
    TestMessage(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.TestMessage",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    AggregationSourceDiscovered(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.AggregationSourceDiscovered",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    LicenseExpired(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.LicenseExpired",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    LicenseChanged(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.LicenseChanged",
    ...
    public RedfishMessage<std::string, std::string>
{
    ...
    LicenseAdded(Args... args) :
        RedfishMessage(
            "ResourceEvent.1.4.0.LicenseAdded",
