    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    TemperatureAboveUpperCautionThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.TemperatureAboveUpperCautionThreshold",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    TemperatureAboveUpperCriticalThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.TemperatureAboveUpperCriticalThreshold",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    TemperatureAboveUpperFatalThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.TemperatureAboveUpperFatalThreshold",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    TemperatureBelowLowerCautionThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.TemperatureBelowLowerCautionThreshold",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    TemperatureBelowLowerCriticalThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.TemperatureBelowLowerCriticalThreshold",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    TemperatureBelowLowerFatalThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.TemperatureBelowLowerFatalThreshold",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    TemperatureBelowUpperFatalThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.TemperatureBelowUpperFatalThreshold",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    TemperatureBelowUpperCriticalThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.TemperatureBelowUpperCriticalThreshold",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    TemperatureAboveLowerFatalThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.TemperatureAboveLowerFatalThreshold",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    TemperatureAboveLowerCriticalThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.TemperatureAboveLowerCriticalThreshold",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    TemperatureWarning(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.TemperatureWarning",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    TemperatureCritical(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.TemperatureCritical",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    TemperatureNoLongerCritical(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.TemperatureNoLongerCritical",
            "Indicates that a temperature reading no longer exceeds an internal critical level, but exceeds an internal warning level.",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    TemperatureNormal(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.TemperatureNormal",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    HumidityAboveUpperCautionThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.HumidityAboveUpperCautionThreshold",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    HumidityAboveUpperCriticalThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.HumidityAboveUpperCriticalThreshold",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    HumidityBelowLowerCautionThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.HumidityBelowLowerCautionThreshold",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    HumidityBelowLowerCriticalThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.HumidityBelowLowerCriticalThreshold",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    HumidityBelowUpperCriticalThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.HumidityBelowUpperCriticalThreshold",
    ...
    public RedfishMessage<std::string, double, double>
{
    ...
    HumidityAboveLowerCriticalThreshold(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.HumidityAboveLowerCriticalThreshold",
    ...
    public RedfishMessage<std::string, double>
{
    ...
    HumidityNormal(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.HumidityNormal",
    ...
    public RedfishMessage<std::string>
{
    ...
    FanRestored(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.FanRestored",
    ...
    public RedfishMessage<std::string>
{
    ...
    FanRemoved(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.FanRemoved",
    ...
    public RedfishMessage<std::string>
{
    ...
    FanInserted(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.FanInserted",
    ...
    public RedfishMessage<std::string>
{
    ...
    FanGroupCritical(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.FanGroupCritical",
    ...
    public RedfishMessage<std::string>
{
    ...
    FanGroupWarning(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.FanGroupWarning",
    ...
    public RedfishMessage<std::string>
{
    ...
    FanGroupNormal(Args... args) :
        RedfishMessage(
            "Environmental.1.0.0.FanGroupNormal",
