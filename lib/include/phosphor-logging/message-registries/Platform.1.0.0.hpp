    ...
    public RedfishMessage<>
{
    ...
    UnhandledExceptionDetectedAfterReset(Args... args) :
        RedfishMessage(
            "Platform.1.0.0.UnhandledExceptionDetectedAfterReset",
    ...
    public RedfishMessage<>
{
    ...
    OperatingSystemCrash(Args... args) :
        RedfishMessage(
            "Platform.1.0.0.OperatingSystemCrash",
    ...
    public RedfishMessage<std::string>
{
    ...
    PlatformErrorAtLocation(Args... args) :
        RedfishMessage(
            "Platform.1.0.0.PlatformErrorAtLocation",
