...
def get_error_yaml_files(i_yaml_dir, i_opyaml_dir, i_test_dir):
    yaml_files = dict()
    #get the openbmc erro yaml files list
    get_error_yaml_files_helper(i_yaml_dir, yaml_files)

    #get the OpenPower error yaml file path
    get_error_yaml_files_helper(i_opyaml_dir, yaml_files)
