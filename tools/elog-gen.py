...
def gen_elog_hpp(i_yaml_dir, i_test_dir, i_output_hpp,
    ...
    parents = dict()
    namespace = dict()
    metadata_process = list()  # metadata that have the 'process' keyword set
    ...
    f.write(template.render(
            ...
            parents=parents, metadata_process=metadata_process))
    f.close()
...
def get_elog_data(i_elog_yaml,
    ...
    (errors, error_msg, error_lvl, meta,
     meta_data, parents, namespace, metadata_process) = o_elog_data
    ...
    for i in mfile:
        ...
        for j in i['meta']:
            ...
            if(('process' in j) and ('true' == j['process'])):
                metadata_process.append(i['name'] + "." + str_short)
