...
SCHEMA_FILE = os.path.join(SCRIPT_DIR, "phosphor-logging", "schemas", "eventfilter.schema.yaml")
TEMPLATE_FILE = os.path.join(SCRIPT_DIR, "phosphor-logging", "templates", "event-filter.mako.cpp")
