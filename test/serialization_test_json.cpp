...
TEST_F(TestJsonSerialization, testBinarySerializationUnchanged)
{
    ...
    auto output = std::make_unique<Entry>(
        ...
        Entry::Level::Informational, "", std::map<std::string, std::string>{},
        phosphor::logging::AssociationList{}, "",
        getEntrySerializePath(outputId), manager);
...
TEST_F(TestJsonSerialization, testJsonRoundTrip)
{
    ...
    auto output = std::make_unique<Entry>(
        ...
        Entry::Level::Informational, "", std::map<std::string, std::string>{},
        phosphor::logging::AssociationList{}, "", getEntrySerializePath(id),
        manager);
