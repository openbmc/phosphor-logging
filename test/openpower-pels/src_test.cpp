...
TEST_F(SRCTest, PlatformDumpStatusCheck)
{
    ...
    {
        EXPECT_CALL(dataIface, checkDumpStatus("bmc/entry")).WillOnce(Return(true));
        EXPECT_CALL(dataIface, checkDumpStatus("resource/entry"))
            .WillOnce(Return(false));
        EXPECT_CALL(dataIface, checkDumpStatus("system/entry"))
            .WillOnce(Return(false));
    ...
    {
        EXPECT_CALL(dataIface, checkDumpStatus("bmc/entry")).WillOnce(Return(false));
        EXPECT_CALL(dataIface, checkDumpStatus("resource/entry"))
