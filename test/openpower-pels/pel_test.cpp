...
nlohmann::json getDIMMInfo(const auto& pel)
{
    ...
    auto hasDIMMInfo = [&dimmInfo](const auto& optionalSection) {
        ...
        else
        {
            ...
            if (userDataJson.contains("DIMMs Manufacturer Info"))
            {
                dimmInfo = userDataJson.at("DIMMs Manufacturer Info");
            }
            else if (
...
{
    {
        ...
        dataIface.addDIMMLocCode("U98D-P0-DIMM0");
        dataIface.addDIMMLocCode("U98D-P0-DIMM1");
